...
//    }
//    private boolean isCommandeIntent(String query) {
//        String lower = query.toLowerCase();
//        return lower.contains("commander")
//                || lower.contains("commande")
//                || lower.contains("ajouter produit")
//                || lower.contains("effectuer une commande")
//                || lower.contains("je veux") && lower.contains("produit");
//    }
//
...
//
//            // 🔍 Si la question concerne Dislogroup
...
//            }
//
//            // 🔍 Si la requête contient une commande, la traiter
//            if (isCommandeIntent(query)) {
//                if (isCommandeIntent(query)) {
//                    Map<String, Object> reponseCommande = geminiService.traiterCommandeDepuisJsonGemini(query);
//                    historique.add("Gemini (commande): " + reponseCommande.get("result"));
//                    return ResponseEntity.ok(reponseCommande);
//                }
//
//            }
//
//            // 🤖 Sinon appel Gemini normal
